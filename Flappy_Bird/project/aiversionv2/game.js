class Game{
  ...
  predict(){
    ...
    let input = [normalize(this.bird.yvel, this.bird.yvelmax), normalize(this.bird.y, height), normalize(next.x-this.bird.x, spaceBetweenObstacles), normalize(next.topheight-this.bird.y, height)]; //second one i not needed
